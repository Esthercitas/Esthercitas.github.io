...
const heracles = {
    ...
    ps: 100, // Puntos de salud actuales
    attacks: [
        { name: "Golpe Titánico", damage: 25 },
        { name: "Embestida Olímpica", damage: 40 },
        { name: "Agarre Indomable", damage: 15 },
        { name: "Lanza Celestial", damage: 30 }
    ]
}; 
...
const leonNemea = {
    ...
    ps: 100,
    attacks: [
        { name: "Zarpazo Bestial", damage: 30 },
        { name: "Rugido Atronador", damage: 35 },
        { name: "Emboscada Felina", damage: 20 },
        { name: "Piel Sagrada", damage: 25 }
    ]
};
...
function showVictory() {
    ...
    victoryLink.href = '../../trabajos/trabajo02.html';
...
function showDefeat() {
    ...
    defeatLink.href = '../../trabajos/trabajo01.html';
