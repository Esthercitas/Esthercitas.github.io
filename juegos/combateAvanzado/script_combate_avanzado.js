...
const heracles = {
    name: "Heracles", 
    maxHp: 500, // Vida máxima
    ps: 500, // Puntos de salud actuales
    attacks: [
...
const leonNemea = {
    ...
    ps: 500,
    attacks: [
        { name: "Cornadas Infernales", damage: 35 },
        { name: "Pisotón Volcánico", damage: 40 },
        { name: "Erupción Minóica", damage: 55 },
        { name: "Maldición de Poseidón", damage: 70 }
    ]
};
...
function showVictory() {
    ...
    victoryLink.href = '../../trabajos/trabajo08.html';
...
function showDefeat() {
    ...
    defeatLink.href = '../../trabajos/trabajo07.html';
