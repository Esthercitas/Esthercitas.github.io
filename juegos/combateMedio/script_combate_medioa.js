...
const heracles = {
    name: "Heracles",
    maxHp: 200, // Vida máxima
    ps: 200, // Puntos de salud actuales
    attacks: [
...
const leonNemea = {
    ...
    ps: 200,
    attacks: [
        { name: "Embestida Salvaje", damage: 40 },
        { name: "Colmillos Afilados", damage: 15 },
        { name: "Pisotón Sísmico", damage: 25 },
        { name: "Aliento Gélido", damage: 30 }
    ]
}; 
...
function showVictory() {
    ...
    victoryLink.href = '../../trabajos/trabajo05.html';
...
function showDefeat() {
    ...
    defeatLink.href = '../../trabajos/trabajo04.html';
