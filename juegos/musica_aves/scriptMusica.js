...
const correctSequence = ['mi', 'mi', 'fa', 'sol', 'sol', 'fa', 'mi', 're', 'do', 'do', 're', 'mi', 'mi', 're', 're', 'mi', 'mi', 'fa', 'sol', 'sol', 'fa', 'mi', 're', 'do', 'do', 're', 'mi', 're', 'do', 'do',];
...
function gameOver(isVictory) {
    ...
    if (isVictory) {
        ...
        messageEl.innerHTML = '<a href="../../trabajos/trabajo07.html" class="victory">¡Victoria!</a>';
        victorySound.play();
    } else {
        // Mostrar mensaje de derrota y reproducir sonido
        messageEl.innerHTML = '<a href="../../trabajos/trabajo06.html" class="defeat">¡Derrota!</a>';
        errorSound.play();
    }
} 
