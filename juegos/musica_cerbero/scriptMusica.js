...
const correctSequence = ['do', 'do', 're', 'do', 'fa', 'mi', 'do', 'do', 're', 'do', 'sol', 'fa', 'do', 'do', 'do2', 'la', 'fa', 'mi', 're', 'do2', 'do2', 'la', 'fa', 'sol', 'fa'];
...
function gameOver(isVictory) {
    ...
    if (isVictory) {
        ...
        cerberoImage.classList.add('fade-out');
        
        cerberoImage.addEventListener('animationend', () => {
            cerberoImage.src = "images/cerbero-calmado.png";
            cerberoImage.classList.remove('fade-out');
            cerberoImage.classList.add('fade-in');
            
            cerberoImage.addEventListener('animationend', () => {
                cerberoImage.classList.remove('fade-in');
            }, { once: true });
        }, { once: true });
        
        // Mostrar mensaje de victoria y reproducir sonido
        messageEl.innerHTML = '<a href="../../trabajos/victoria.html" class="victory">¡Victoria!</a>';
        victorySound.play();
    } else {
        // Mostrar mensaje de derrota y reproducir sonido
        messageEl.innerHTML = '<a href="../../trabajos/derrota.html" class="defeat">¡Derrota!</a>';
        errorSound.play();
    }
} 
